...
if __name__ == "__main__":
    ...
    train_data_indices, y_train_indices= sentences_to_indices ( np.array(train_data), word_to_index = words_to_index, max_len =maxLen, vocabulary=len(words_to_index))
    test_data_indices, y_test_indices= sentences_to_indices ( np.array(test_data), word_to_index = words_to_index, max_len =maxLen, vocabulary=len(words_to_index))
